...
func (_m *MockVotings) Create(ctx context.Context, body dto.VotingCreateRequest) (*dto.Voting, error) {
	...
	var r0 *dto.Voting
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, dto.VotingCreateRequest) (*dto.Voting, error)); ok {
		return rf(ctx, body)
	}
	if rf, ok := ret.Get(0).(func(context.Context, dto.VotingCreateRequest) *dto.Voting); ok {
		r0 = rf(ctx, body)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*dto.Voting)
		}
	}

	if rf, ok := ret.Get(1).(func(context.Context, dto.VotingCreateRequest) error); ok {
		r1 = rf(ctx, body)
	} else {
		r1 = ret.Error(1)
	}
...
func (_c *MockVotings_Create_Call) Run(run func(ctx context.Context, body dto.VotingCreateRequest)) *MockVotings_Create_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(dto.VotingCreateRequest))
	})
	return _c
}

func (_c *MockVotings_Create_Call) Return(_a0 *dto.Voting, _a1 error) *MockVotings_Create_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockVotings_Create_Call) RunAndReturn(run func(context.Context, dto.VotingCreateRequest) (*dto.Voting, error)) *MockVotings_Create_Call {
	_c.Call.Return(run)
	return _c
}

// Get provides a mock function with given fields: ctx, board, id
func (_m *MockVotings) Get(ctx context.Context, board uuid.UUID, id uuid.UUID) (*dto.Voting, error) {
	...
	var r0 *dto.Voting
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, uuid.UUID, uuid.UUID) (*dto.Voting, error)); ok {
		return rf(ctx, board, id)
	}
	if rf, ok := ret.Get(0).(func(context.Context, uuid.UUID, uuid.UUID) *dto.Voting); ok {
		r0 = rf(ctx, board, id)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*dto.Voting)
...
func (_c *MockVotings_Get_Call) Return(_a0 *dto.Voting, _a1 error) *MockVotings_Get_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockVotings_Get_Call) RunAndReturn(run func(context.Context, uuid.UUID, uuid.UUID) (*dto.Voting, error)) *MockVotings_Get_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *MockVotings) List(ctx context.Context, board uuid.UUID) ([]*dto.Voting, error) {
	...
	var r0 []*dto.Voting
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, uuid.UUID) ([]*dto.Voting, error)); ok {
		return rf(ctx, board)
	}
	if rf, ok := ret.Get(0).(func(context.Context, uuid.UUID) []*dto.Voting); ok {
		r0 = rf(ctx, board)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).([]*dto.Voting)
...
func (_c *MockVotings_List_Call) Return(_a0 []*dto.Voting, _a1 error) *MockVotings_List_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockVotings_List_Call) RunAndReturn(run func(context.Context, uuid.UUID) ([]*dto.Voting, error)) *MockVotings_List_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *MockVotings) Update(ctx context.Context, body dto.VotingUpdateRequest) (*dto.Voting, error) {
	ret := _m.Called(ctx, body)
	...
	var r0 *dto.Voting
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, dto.VotingUpdateRequest) (*dto.Voting, error)); ok {
		return rf(ctx, body)
	}
	if rf, ok := ret.Get(0).(func(context.Context, dto.VotingUpdateRequest) *dto.Voting); ok {
		r0 = rf(ctx, body)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*dto.Voting)
	...
	if rf, ok := ret.Get(1).(func(context.Context, dto.VotingUpdateRequest) error); ok {
		r1 = rf(ctx, body)
	} else {
		r1 = ret.Error(1)
	}
...
func (_c *MockVotings_Update_Call) Run(run func(ctx context.Context, body dto.VotingUpdateRequest)) *MockVotings_Update_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(dto.VotingUpdateRequest))
	})
	return _c
}

func (_c *MockVotings_Update_Call) Return(_a0 *dto.Voting, _a1 error) *MockVotings_Update_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockVotings_Update_Call) RunAndReturn(run func(context.Context, dto.VotingUpdateRequest) (*dto.Voting, error)) *MockVotings_Update_Call {
	_c.Call.Return(run)
	return _c
}
