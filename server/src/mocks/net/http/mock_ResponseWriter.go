...
func (_m *MockResponseWriter) Header() Header {
	ret := _m.Called()
...
func (_c *MockResponseWriter_Header_Call) Return(_a0 Header) *MockResponseWriter_Header_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *MockResponseWriter_Header_Call) RunAndReturn(run func() Header) *MockResponseWriter_Header_Call {
	_c.Call.Return(run)
	return _c
}
