...
func (_mock *MockClient) SubscribeToBoardEvents(subject string) (chan *realtime.BoardEvent, error) {
	...
	var r1 error
	if returnFunc, ok := ret.Get(0).(func(string) (chan *realtime.BoardEvent, error)); ok {
		return returnFunc(subject)
	}
	if returnFunc, ok := ret.Get(0).(func(string) chan *realtime.BoardEvent); ok {
...
func (_c *MockClient_SubscribeToBoardEvents_Call) Return(boardEventCh chan *realtime.BoardEvent, err error) *MockClient_SubscribeToBoardEvents_Call {
	_c.Call.Return(boardEventCh, err)
	return _c
}

func (_c *MockClient_SubscribeToBoardEvents_Call) RunAndReturn(run func(subject string) (chan *realtime.BoardEvent, error)) *MockClient_SubscribeToBoardEvents_Call {
	_c.Call.Return(run)
	return _c
}

// SubscribeToBoardSessionEvents provides a mock function for the type MockClient
func (_mock *MockClient) SubscribeToBoardSessionEvents(subject string) (chan *realtime.BoardSessionRequestEventType, error) {
	ret := _mock.Called(subject)
	...
	var r1 error
	if returnFunc, ok := ret.Get(0).(func(string) (chan *realtime.BoardSessionRequestEventType, error)); ok {
		return returnFunc(subject)
	}
	if returnFunc, ok := ret.Get(0).(func(string) chan *realtime.BoardSessionRequestEventType); ok {
		r0 = returnFunc(subject)
	} else {
		if ret.Get(0) != nil {
...
func (_c *MockClient_SubscribeToBoardSessionEvents_Call) Return(boardSessionRequestEventTypeCh chan *realtime.BoardSessionRequestEventType, err error) *MockClient_SubscribeToBoardSessionEvents_Call {
	_c.Call.Return(boardSessionRequestEventTypeCh, err)
	return _c
}

func (_c *MockClient_SubscribeToBoardSessionEvents_Call) RunAndReturn(run func(subject string) (chan *realtime.BoardSessionRequestEventType, error)) *MockClient_SubscribeToBoardSessionEvents_Call {
	_c.Call.Return(run)
	return _c
}
