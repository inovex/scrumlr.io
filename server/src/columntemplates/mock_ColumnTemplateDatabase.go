...
func (_mock *MockColumnTemplateDatabase) Delete(ctx context.Context, board uuid.UUID, column uuid.UUID, user uuid.UUID) error {
...
//   - column uuid.UUID
//   - user uuid.UUID
func (_e *MockColumnTemplateDatabase_Expecter) Delete(ctx interface{}, board interface{}, column interface{}, user interface{}) *MockColumnTemplateDatabase_Delete_Call {
	return &MockColumnTemplateDatabase_Delete_Call{Call: _e.mock.On("Delete", ctx, board, column, user)}
}

func (_c *MockColumnTemplateDatabase_Delete_Call) Run(run func(ctx context.Context, board uuid.UUID, column uuid.UUID, user uuid.UUID)) *MockColumnTemplateDatabase_Delete_Call {
	_c.Call.Run(func(args mock.Arguments) {
		var arg0 context.Context
		if args[0] != nil {
			arg0 = args[0].(context.Context)
...
func (_c *MockColumnTemplateDatabase_Delete_Call) RunAndReturn(run func(ctx context.Context, board uuid.UUID, column uuid.UUID, user uuid.UUID) error) *MockColumnTemplateDatabase_Delete_Call {
	_c.Call.Return(run)
	return _c
}
