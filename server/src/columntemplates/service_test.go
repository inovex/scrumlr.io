...
func TestDeleteColumnTemplate(t *testing.T) {
	...
	mockColumnTemplateDatabase := NewMockColumnTemplateDatabase(t)
	mockColumnTemplateDatabase.EXPECT().Delete(mock.Anything, boardId, columnId, userId).Return(nil)
...
func TestDeleteColumnTemplate_DatabaseError(t *testing.T) {
	...
	mockColumnTemplateDatabase := NewMockColumnTemplateDatabase(t)
	mockColumnTemplateDatabase.EXPECT().Delete(mock.Anything, boardId, columnId, userId).Return(dbError)
