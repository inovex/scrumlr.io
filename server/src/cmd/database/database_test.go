...
func TestGetVersion(t *testing.T) {
	...
	assert.NoError(t, err)
	assert.Equal(t, fmt.Sprintf("database at migration version %d, all migration applied successfully %t\n", currentVersion, true), out.String())
}
...
func TestGetVersionNotMigrated(t *testing.T) {
	...
	assert.NoError(t, err)
	assert.Equal(t, "database not yet migrated\n", out.String())
}
...
func TestMigrateUp(t *testing.T) {
	...
	assert.NoError(t, err)
	assert.Equal(t, fmt.Sprintf("successfully migrated database to version %d\n", currentVersion), out.String())
}
