...
func TestGetReaction(t *testing.T) {
	...
	mockReactionDb.EXPECT().Get(id).Return(DatabaseReaction{ID: id, Note: noteId, User: userId, ReactionType: reactionType}, nil)
...
func TestGetReaction_NotFound(t *testing.T) {
	id := uuid.New()
	mockReactionDb := NewMockReactionDatabase(t)
	mockReactionDb.EXPECT().Get(id).Return(DatabaseReaction{}, sql.ErrNoRows)
...
func TestGetReaction_DatabaseError(t *testing.T) {
	id := uuid.New()
	mockReactionDb := NewMockReactionDatabase(t)
	mockReactionDb.EXPECT().Get(id).Return(DatabaseReaction{}, errors.New("database error"))
...
func TestGetAllReactions(t *testing.T) {
	boardId := uuid.New()
	mockReactionDb := NewMockReactionDatabase(t)
	mockReactionDb.EXPECT().GetAll(boardId).Return([]DatabaseReaction{
...
func TestGetAllReactions_NotFound(t *testing.T) {
	boardId := uuid.New()
	mockReactionDb := NewMockReactionDatabase(t)
	mockReactionDb.EXPECT().GetAll(boardId).Return([]DatabaseReaction{}, nil)
...
func TestGetAllReactions_DatabaseError(t *testing.T) {
	boardId := uuid.New()
	mockReactionDb := NewMockReactionDatabase(t)
	mockReactionDb.EXPECT().GetAll(boardId).Return(nil, errors.New("database error"))
...
func TestCreateReaction(t *testing.T) {
	...
	mockReactionDb := NewMockReactionDatabase(t)
	mockReactionDb.EXPECT().GetAllForNote(noteId).
		Return([]DatabaseReaction{{ID: uuid.New(), Note: noteId, User: uuid.New(), ReactionType: Heart}}, nil)
	mockReactionDb.EXPECT().Create(boardId, DatabaseReactionInsert{Note: noteId, User: userId, ReactionType: reactionType}).
...
func TestDeleteReaction(t *testing.T) {
	...
	mockReactionDb := NewMockReactionDatabase(t)
	mockReactionDb.EXPECT().Get(Id).
		Return(DatabaseReaction{ID: Id, Note: noteId, User: userId, ReactionType: reactionType}, nil)
	mockReactionDb.EXPECT().Delete(Id).Return(nil)
...
func TestDeleteReaction_NotFound(t *testing.T) {
	...
	mockReactionDb := NewMockReactionDatabase(t)
	mockReactionDb.EXPECT().Get(reactionId).
...
func TestDeleteReaction_DatabaseError(t *testing.T) {
	...
	mockReactionDb.EXPECT().Delete(reactionId).
...
func TestUpdateReaction(t *testing.T) {
	...
	mockReactionDb.EXPECT().Update(Id, DatabaseReactionUpdate{ReactionType: reactionType}).
...
func TestUpdateReaction_DatabaseError(t *testing.T) {
	...
	mockReactionDb.EXPECT().Update(Id, DatabaseReactionUpdate{ReactionType: Poop}).
		Return(DatabaseReaction{}, errors.New("database error"))
