...
// Create provides a mock function with given fields: ctx, board, insert
func (_m *MockReactionDatabase) Create(ctx context.Context, board uuid.UUID, insert DatabaseReactionInsert) (DatabaseReaction, error) {
	ret := _m.Called(ctx, board, insert)
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, uuid.UUID, DatabaseReactionInsert) (DatabaseReaction, error)); ok {
		return rf(ctx, board, insert)
	}
	if rf, ok := ret.Get(0).(func(context.Context, uuid.UUID, DatabaseReactionInsert) DatabaseReaction); ok {
		r0 = rf(ctx, board, insert)
	} else {
		r0 = ret.Get(0).(DatabaseReaction)
	}

	if rf, ok := ret.Get(1).(func(context.Context, uuid.UUID, DatabaseReactionInsert) error); ok {
		r1 = rf(ctx, board, insert)
	} else {
		r1 = ret.Error(1)
	}
...
func (_c *MockReactionDatabase_Create_Call) Run(run func(ctx context.Context, board uuid.UUID, insert DatabaseReactionInsert)) *MockReactionDatabase_Create_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(uuid.UUID), args[2].(DatabaseReactionInsert))
	})
	return _c
}
...
func (_c *MockReactionDatabase_Create_Call) RunAndReturn(run func(context.Context, uuid.UUID, DatabaseReactionInsert) (DatabaseReaction, error)) *MockReactionDatabase_Create_Call {
	_c.Call.Return(run)
	return _c
}

// Delete provides a mock function with given fields: ctx, id
func (_m *MockReactionDatabase) Delete(ctx context.Context, id uuid.UUID) error {
...
func (_c *MockReactionDatabase_Delete_Call) Run(run func(ctx context.Context, id uuid.UUID)) *MockReactionDatabase_Delete_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *MockReactionDatabase_Delete_Call) RunAndReturn(run func(context.Context, uuid.UUID) error) *MockReactionDatabase_Delete_Call {
	_c.Call.Return(run)
	return _c
}

// Get provides a mock function with given fields: ctx, id
func (_m *MockReactionDatabase) Get(ctx context.Context, id uuid.UUID) (DatabaseReaction, error) {
	ret := _m.Called(ctx, id)
	...
	var r0 DatabaseReaction
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, uuid.UUID) (DatabaseReaction, error)); ok {
		return rf(ctx, id)
	}
	if rf, ok := ret.Get(0).(func(context.Context, uuid.UUID) DatabaseReaction); ok {
		r0 = rf(ctx, id)
	} else {
		r0 = ret.Get(0).(DatabaseReaction)
	}
...
func (_c *MockReactionDatabase_Get_Call) RunAndReturn(run func(context.Context, uuid.UUID) (DatabaseReaction, error)) *MockReactionDatabase_Get_Call {
	_c.Call.Return(run)
	return _c
}

// GetAll provides a mock function with given fields: ctx, board
func (_m *MockReactionDatabase) GetAll(ctx context.Context, board uuid.UUID) ([]DatabaseReaction, error) {
...
func (_c *MockReactionDatabase_GetAll_Call) RunAndReturn(run func(context.Context, uuid.UUID) ([]DatabaseReaction, error)) *MockReactionDatabase_GetAll_Call {
	_c.Call.Return(run)
	return _c
}

// GetAllForNote provides a mock function with given fields: ctx, note
func (_m *MockReactionDatabase) GetAllForNote(ctx context.Context, note uuid.UUID) ([]DatabaseReaction, error) {
...
func (_c *MockReactionDatabase_GetAllForNote_Call) RunAndReturn(run func(context.Context, uuid.UUID) ([]DatabaseReaction, error)) *MockReactionDatabase_GetAllForNote_Call {
	_c.Call.Return(run)
	return _c
}

// Update provides a mock function with given fields: ctx, id, update
func (_m *MockReactionDatabase) Update(ctx context.Context, id uuid.UUID, update DatabaseReactionUpdate) (DatabaseReaction, error) {
	...
	var r0 DatabaseReaction
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, uuid.UUID, DatabaseReactionUpdate) (DatabaseReaction, error)); ok {
		return rf(ctx, id, update)
	}
	if rf, ok := ret.Get(0).(func(context.Context, uuid.UUID, DatabaseReactionUpdate) DatabaseReaction); ok {
		r0 = rf(ctx, id, update)
	} else {
		r0 = ret.Get(0).(DatabaseReaction)
	}

	if rf, ok := ret.Get(1).(func(context.Context, uuid.UUID, DatabaseReactionUpdate) error); ok {
		r1 = rf(ctx, id, update)
	} else {
		r1 = ret.Error(1)
	}
...
func (_c *MockReactionDatabase_Update_Call) Run(run func(ctx context.Context, id uuid.UUID, update DatabaseReactionUpdate)) *MockReactionDatabase_Update_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(uuid.UUID), args[2].(DatabaseReactionUpdate))
	})
	return _c
}
...
func (_c *MockReactionDatabase_Update_Call) RunAndReturn(run func(context.Context, uuid.UUID, DatabaseReactionUpdate) (DatabaseReaction, error)) *MockReactionDatabase_Update_Call {
	_c.Call.Return(run)
	return _c
}
