...
func (_m *MockReactionDatabase) CreateReaction(board uuid.UUID, insert reactions.DatabaseReactionInsert) (reactions.DatabaseReaction, error) {
	...
	var r0 reactions.DatabaseReaction
	var r1 error
	if rf, ok := ret.Get(0).(func(uuid.UUID, reactions.DatabaseReactionInsert) (reactions.DatabaseReaction, error)); ok {
		return rf(board, insert)
	}
	if rf, ok := ret.Get(0).(func(uuid.UUID, reactions.DatabaseReactionInsert) reactions.DatabaseReaction); ok {
		r0 = rf(board, insert)
	} else {
		r0 = ret.Get(0).(reactions.DatabaseReaction)
	}

	if rf, ok := ret.Get(1).(func(uuid.UUID, reactions.DatabaseReactionInsert) error); ok {
		r1 = rf(board, insert)
	} else {
		r1 = ret.Error(1)
	}
...
func (_c *MockReactionDatabase_CreateReaction_Call) Run(run func(board uuid.UUID, insert reactions.DatabaseReactionInsert)) *MockReactionDatabase_CreateReaction_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(uuid.UUID), args[1].(reactions.DatabaseReactionInsert))
	})
	return _c
}

func (_c *MockReactionDatabase_CreateReaction_Call) Return(_a0 reactions.DatabaseReaction, _a1 error) *MockReactionDatabase_CreateReaction_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockReactionDatabase_CreateReaction_Call) RunAndReturn(run func(uuid.UUID, reactions.DatabaseReactionInsert) (reactions.DatabaseReaction, error)) *MockReactionDatabase_CreateReaction_Call {
	_c.Call.Return(run)
	return _c
}

// GetReaction provides a mock function with given fields: id
func (_m *MockReactionDatabase) GetReaction(id uuid.UUID) (reactions.DatabaseReaction, error) {
	ret := _m.Called(id)
	...
	var r0 reactions.DatabaseReaction
	var r1 error
	if rf, ok := ret.Get(0).(func(uuid.UUID) (reactions.DatabaseReaction, error)); ok {
		return rf(id)
	}
	if rf, ok := ret.Get(0).(func(uuid.UUID) reactions.DatabaseReaction); ok {
		r0 = rf(id)
	} else {
		r0 = ret.Get(0).(reactions.DatabaseReaction)
	}
...
func (_c *MockReactionDatabase_GetReaction_Call) Return(_a0 reactions.DatabaseReaction, _a1 error) *MockReactionDatabase_GetReaction_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockReactionDatabase_GetReaction_Call) RunAndReturn(run func(uuid.UUID) (reactions.DatabaseReaction, error)) *MockReactionDatabase_GetReaction_Call {
	_c.Call.Return(run)
	return _c
}

// GetReactions provides a mock function with given fields: board
func (_m *MockReactionDatabase) GetReactions(board uuid.UUID) ([]reactions.DatabaseReaction, error) {
	ret := _m.Called(board)
...
func (_c *MockReactionDatabase_GetReactions_Call) Return(_a0 []reactions.DatabaseReaction, _a1 error) *MockReactionDatabase_GetReactions_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockReactionDatabase_GetReactions_Call) RunAndReturn(run func(uuid.UUID) ([]reactions.DatabaseReaction, error)) *MockReactionDatabase_GetReactions_Call {
	_c.Call.Return(run)
	return _c
}

// GetReactionsForNote provides a mock function with given fields: note
func (_m *MockReactionDatabase) GetReactionsForNote(note uuid.UUID) ([]reactions.DatabaseReaction, error) {
	ret := _m.Called(note)
...
func (_c *MockReactionDatabase_GetReactionsForNote_Call) Return(_a0 []reactions.DatabaseReaction, _a1 error) *MockReactionDatabase_GetReactionsForNote_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockReactionDatabase_GetReactionsForNote_Call) RunAndReturn(run func(uuid.UUID) ([]reactions.DatabaseReaction, error)) *MockReactionDatabase_GetReactionsForNote_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *MockReactionDatabase) UpdateReaction(board uuid.UUID, user uuid.UUID, id uuid.UUID, update reactions.DatabaseReactionUpdate) (reactions.DatabaseReaction, error) {
	...
	var r0 reactions.DatabaseReaction
	var r1 error
	if rf, ok := ret.Get(0).(func(uuid.UUID, uuid.UUID, uuid.UUID, reactions.DatabaseReactionUpdate) (reactions.DatabaseReaction, error)); ok {
		return rf(board, user, id, update)
	}
	if rf, ok := ret.Get(0).(func(uuid.UUID, uuid.UUID, uuid.UUID, reactions.DatabaseReactionUpdate) reactions.DatabaseReaction); ok {
		r0 = rf(board, user, id, update)
	} else {
		r0 = ret.Get(0).(reactions.DatabaseReaction)
	}

	if rf, ok := ret.Get(1).(func(uuid.UUID, uuid.UUID, uuid.UUID, reactions.DatabaseReactionUpdate) error); ok {
...
func (_c *MockReactionDatabase_UpdateReaction_Call) Run(run func(board uuid.UUID, user uuid.UUID, id uuid.UUID, update reactions.DatabaseReactionUpdate)) *MockReactionDatabase_UpdateReaction_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(uuid.UUID), args[1].(uuid.UUID), args[2].(uuid.UUID), args[3].(reactions.DatabaseReactionUpdate))
	})
	return _c
}

func (_c *MockReactionDatabase_UpdateReaction_Call) Return(_a0 reactions.DatabaseReaction, _a1 error) *MockReactionDatabase_UpdateReaction_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockReactionDatabase_UpdateReaction_Call) RunAndReturn(run func(uuid.UUID, uuid.UUID, uuid.UUID, reactions.DatabaseReactionUpdate) (reactions.DatabaseReaction, error)) *MockReactionDatabase_UpdateReaction_Call {
	_c.Call.Return(run)
	return _c
}
