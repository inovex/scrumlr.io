...
func (_m *MockReactionService) Create(ctx context.Context, board uuid.UUID, body reactions.ReactionCreateRequest) (*reactions.Reaction, error) {
	...
	var r0 *reactions.Reaction
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, uuid.UUID, reactions.ReactionCreateRequest) (*reactions.Reaction, error)); ok {
		return rf(ctx, board, body)
	}
	if rf, ok := ret.Get(0).(func(context.Context, uuid.UUID, reactions.ReactionCreateRequest) *reactions.Reaction); ok {
		r0 = rf(ctx, board, body)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*reactions.Reaction)
		}
	}

	if rf, ok := ret.Get(1).(func(context.Context, uuid.UUID, reactions.ReactionCreateRequest) error); ok {
...
func (_c *MockReactionService_Create_Call) Run(run func(ctx context.Context, board uuid.UUID, body reactions.ReactionCreateRequest)) *MockReactionService_Create_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(uuid.UUID), args[2].(reactions.ReactionCreateRequest))
	})
	return _c
}

func (_c *MockReactionService_Create_Call) Return(_a0 *reactions.Reaction, _a1 error) *MockReactionService_Create_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockReactionService_Create_Call) RunAndReturn(run func(context.Context, uuid.UUID, reactions.ReactionCreateRequest) (*reactions.Reaction, error)) *MockReactionService_Create_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *MockReactionService) Get(ctx context.Context, id uuid.UUID) (*reactions.Reaction, error) {
	...
	var r0 *reactions.Reaction
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, uuid.UUID) (*reactions.Reaction, error)); ok {
		return rf(ctx, id)
	}
	if rf, ok := ret.Get(0).(func(context.Context, uuid.UUID) *reactions.Reaction); ok {
		r0 = rf(ctx, id)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*reactions.Reaction)
...
func (_c *MockReactionService_Get_Call) Return(_a0 *reactions.Reaction, _a1 error) *MockReactionService_Get_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockReactionService_Get_Call) RunAndReturn(run func(context.Context, uuid.UUID) (*reactions.Reaction, error)) *MockReactionService_Get_Call {
	_c.Call.Return(run)
	return _c
}

// List provides a mock function with given fields: ctx, boardId
func (_m *MockReactionService) List(ctx context.Context, boardId uuid.UUID) ([]*reactions.Reaction, error) {
...
func (_c *MockReactionService_List_Call) Return(_a0 []*reactions.Reaction, _a1 error) *MockReactionService_List_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockReactionService_List_Call) RunAndReturn(run func(context.Context, uuid.UUID) ([]*reactions.Reaction, error)) *MockReactionService_List_Call {
	_c.Call.Return(run)
	return _c
}

// Update provides a mock function with given fields: ctx, board, user, id, body
func (_m *MockReactionService) Update(ctx context.Context, board uuid.UUID, user uuid.UUID, id uuid.UUID, body reactions.ReactionUpdateTypeRequest) (*reactions.Reaction, error) {
	...
	var r0 *reactions.Reaction
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, uuid.UUID, uuid.UUID, uuid.UUID, reactions.ReactionUpdateTypeRequest) (*reactions.Reaction, error)); ok {
		return rf(ctx, board, user, id, body)
	}
	if rf, ok := ret.Get(0).(func(context.Context, uuid.UUID, uuid.UUID, uuid.UUID, reactions.ReactionUpdateTypeRequest) *reactions.Reaction); ok {
	...
	if rf, ok := ret.Get(1).(func(context.Context, uuid.UUID, uuid.UUID, uuid.UUID, reactions.ReactionUpdateTypeRequest) error); ok {
...
func (_c *MockReactionService_Update_Call) Run(run func(ctx context.Context, board uuid.UUID, user uuid.UUID, id uuid.UUID, body reactions.ReactionUpdateTypeRequest)) *MockReactionService_Update_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(uuid.UUID), args[2].(uuid.UUID), args[3].(uuid.UUID), args[4].(reactions.ReactionUpdateTypeRequest))
	})
	return _c
}

func (_c *MockReactionService_Update_Call) Return(_a0 *reactions.Reaction, _a1 error) *MockReactionService_Update_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockReactionService_Update_Call) RunAndReturn(run func(context.Context, uuid.UUID, uuid.UUID, uuid.UUID, reactions.ReactionUpdateTypeRequest) (*reactions.Reaction, error)) *MockReactionService_Update_Call {
	_c.Call.Return(run)
	return _c
}
