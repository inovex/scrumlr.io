...
func (_m *MockReactionService) Create(ctx context.Context, body ReactionCreateRequest) (*Reaction, error) {
	...
	var r0 *Reaction
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, ReactionCreateRequest) (*Reaction, error)); ok {
		return rf(ctx, body)
	}
	if rf, ok := ret.Get(0).(func(context.Context, ReactionCreateRequest) *Reaction); ok {
		r0 = rf(ctx, body)
	} else {
		if ret.Get(0) != nil {
	...
	if rf, ok := ret.Get(1).(func(context.Context, ReactionCreateRequest) error); ok {
		r1 = rf(ctx, body)
	} else {
		r1 = ret.Error(1)
	}
...
func (_c *MockReactionService_Create_Call) Run(run func(ctx context.Context, body ReactionCreateRequest)) *MockReactionService_Create_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(ReactionCreateRequest))
	})
	return _c
}
...
func (_c *MockReactionService_Create_Call) RunAndReturn(run func(context.Context, ReactionCreateRequest) (*Reaction, error)) *MockReactionService_Create_Call {
	_c.Call.Return(run)
	return _c
}
