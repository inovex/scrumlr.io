...
func (_m *MockHealthDatabase) IsHealthy(ctx context.Context) bool {
	ret := _m.Called(ctx)
...
func (_c *MockHealthDatabase_IsHealthy_Call) RunAndReturn(run func(context.Context) bool) *MockHealthDatabase_IsHealthy_Call {
	_c.Call.Return(run)
	return _c
}
