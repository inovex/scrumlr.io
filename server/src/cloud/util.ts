...
export const api = <RequestData extends ParseObjectParams = ParseObjectParams, ResponseType = void>(name: string, call: (user: Parse.User, request: RequestData) => ResponseType | Promise<ResponseType>) => {
