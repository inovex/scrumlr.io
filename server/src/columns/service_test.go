...
func (suite *ColumnServiceTestSuite) TestCreateColumn() {
	...
	suite.expectColumnCreatedAndBroadcastOnSuccess(suite.createDatabaseColumnInsert(), columnToCreate, nil)
	suite.expectBoardLastModifiedAtUpdated()
...
func (suite *ColumnServiceTestSuite) TestCreateColumn_DatabaseError() {
	...
	suite.expectGetIndex()
	suite.expectColumnCreatedAndBroadcastOnSuccess(suite.createDatabaseColumnInsert(), DatabaseColumn{}, dbError)
...
func (suite *ColumnServiceTestSuite) TestUpdateColumn() {
	...
	suite.expectColumnsUpdatedAndBroadcastOnSuccess(mockedColumn, nil)
...
func (suite *ColumnServiceTestSuite) TestUpdateColumn_DatabaseError() {
	dbError := errors.New("Database error")
	suite.expectColumnsUpdatedAndBroadcastOnSuccess(DatabaseColumn{}, dbError)
...
func (suite *ColumnServiceTestSuite) expectColumnsUpdatedAndBroadcastOnSuccess(result DatabaseColumn, err error) {
...
func (suite *ColumnServiceTestSuite) expectColumnCreatedAndBroadcastOnSuccess(insert DatabaseColumnInsert, result DatabaseColumn, err error) {
...
func (suite *ColumnServiceTestSuite) expectBoardLastModifiedAtUpdated() {
	suite.mockBoardModifiedUpdater.EXPECT().UpdateLastModified(mock.Anything, suite.boardID, time.Now()).Return(nil)
}
