...
// GetCount provides a mock function with given fields: ctx, boardID
func (_m *MockColumnService) GetCount(ctx context.Context, boardID uuid.UUID) (int, error) {
	ret := _m.Called(ctx, boardID)
...
func (_c *MockColumnService_GetCount_Call) Return(_a0 int, _a1 error) *MockColumnService_GetCount_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockColumnService_GetCount_Call) RunAndReturn(run func(context.Context, uuid.UUID) (int, error)) *MockColumnService_GetCount_Call {
	_c.Call.Return(run)
	return _c
}
