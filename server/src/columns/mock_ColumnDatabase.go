...
func (_mock *MockColumnDatabase) Delete(ctx context.Context, board uuid.UUID, column uuid.UUID, user uuid.UUID) error {
...
//   - column uuid.UUID
//   - user uuid.UUID
func (_e *MockColumnDatabase_Expecter) Delete(ctx interface{}, board interface{}, column interface{}, user interface{}) *MockColumnDatabase_Delete_Call {
	return &MockColumnDatabase_Delete_Call{Call: _e.mock.On("Delete", ctx, board, column, user)}
}

func (_c *MockColumnDatabase_Delete_Call) Run(run func(ctx context.Context, board uuid.UUID, column uuid.UUID, user uuid.UUID)) *MockColumnDatabase_Delete_Call {
	_c.Call.Run(func(args mock.Arguments) {
		var arg0 context.Context
		if args[0] != nil {
			arg0 = args[0].(context.Context)
...
func (_c *MockColumnDatabase_Delete_Call) RunAndReturn(run func(ctx context.Context, board uuid.UUID, column uuid.UUID, user uuid.UUID) error) *MockColumnDatabase_Delete_Call {
	_c.Call.Return(run)
	return _c
}
