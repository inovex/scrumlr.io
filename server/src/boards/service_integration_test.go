...
func (suite *BoardServiceIntegrationTestSuite) initTestData() {
	...
	suite.boards = map[string]Board{
		...
		"UpdateInviteToPublic":     {ID: uuid.MustParse("b1c2d3e4-f5a6-7890-abcd-ef1234567109"), Name: new("UpdateToPublic"), Description: new("This is a board to update"), AccessPolicy: ByInvite, ShowAuthors: true, ShowNotesOfOtherUsers: true, ShowNoteReactions: true, AllowStacking: true, IsLocked: false},
