...
func (suite *DatabaseBoardTestSuite) Test_Database_UpdateBoard_SetsLastModifiedAt() {
  ...
  assert.True(t, dbBoard.LastModifiedAt.After(timeBeforeUpdate) || dbBoard.LastModifiedAt.Equal(timeBeforeUpdate), "LastModifiedAt should be at or after timeBeforeUpdate")
}
