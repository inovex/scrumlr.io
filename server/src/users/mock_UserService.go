...
// GetBoardUsers provides a mock function with given fields: ctx, boardID
func (_m *MockUserService) GetBoardUsers(ctx context.Context, boardID uuid.UUID) ([]*User, error) {
...
func (_c *MockUserService_GetBoardUsers_Call) Return(_a0 []*User, _a1 error) *MockUserService_GetBoardUsers_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockUserService_GetBoardUsers_Call) RunAndReturn(run func(context.Context, uuid.UUID) ([]*User, error)) *MockUserService_GetBoardUsers_Call {
	_c.Call.Return(run)
	return _c
}
