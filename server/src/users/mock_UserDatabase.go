...
// GetMultipleUsers provides a mock function for the type MockUserDatabase
func (_mock *MockUserDatabase) GetMultipleUsers(ctx context.Context, ids []uuid.UUID) ([]DatabaseUser, error) {
	ret := _mock.Called(ctx, ids)

	if len(ret) == 0 {
		panic("no return value specified for GetMultipleUsers")
	}
...
// MockUserDatabase_GetMultipleUsers_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'GetMultipleUsers'
type MockUserDatabase_GetMultipleUsers_Call struct {
	*mock.Call
}

// GetMultipleUsers is a helper method to define mock.On call
//   - ctx context.Context
//   - ids []uuid.UUID
func (_e *MockUserDatabase_Expecter) GetMultipleUsers(ctx interface{}, ids interface{}) *MockUserDatabase_GetMultipleUsers_Call {
	return &MockUserDatabase_GetMultipleUsers_Call{Call: _e.mock.On("GetMultipleUsers", ctx, ids)}
}

func (_c *MockUserDatabase_GetMultipleUsers_Call) Run(run func(ctx context.Context, ids []uuid.UUID)) *MockUserDatabase_GetMultipleUsers_Call {
	_c.Call.Run(func(args mock.Arguments) {
		var arg0 context.Context
		if args[0] != nil {
			arg0 = args[0].(context.Context)
...
func (_c *MockUserDatabase_GetMultipleUsers_Call) Return(databaseUsers []DatabaseUser, err error) *MockUserDatabase_GetMultipleUsers_Call {
	_c.Call.Return(databaseUsers, err)
	return _c
}

func (_c *MockUserDatabase_GetMultipleUsers_Call) RunAndReturn(run func(ctx context.Context, ids []uuid.UUID) ([]DatabaseUser, error)) *MockUserDatabase_GetMultipleUsers_Call {
	_c.Call.Return(run)
	return _c
}
