...
// Gets provides a mock function with given fields: ctx, boardID, statusQuery
func (_m *MockSessionRequestService) Gets(ctx context.Context, boardID uuid.UUID, statusQuery string) ([]*BoardSessionRequest, error) {
...
// MockSessionRequestService_Gets_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'Gets'
type MockSessionRequestService_Gets_Call struct {
	*mock.Call
}
...
//   - boardID uuid.UUID
//   - statusQuery string
func (_e *MockSessionRequestService_Expecter) Gets(ctx interface{}, boardID interface{}, statusQuery interface{}) *MockSessionRequestService_Gets_Call {
	return &MockSessionRequestService_Gets_Call{Call: _e.mock.On("Gets", ctx, boardID, statusQuery)}
}

func (_c *MockSessionRequestService_Gets_Call) Run(run func(ctx context.Context, boardID uuid.UUID, statusQuery string)) *MockSessionRequestService_Gets_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *MockSessionRequestService_Gets_Call) Return(_a0 []*BoardSessionRequest, _a1 error) *MockSessionRequestService_Gets_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockSessionRequestService_Gets_Call) RunAndReturn(run func(context.Context, uuid.UUID, string) ([]*BoardSessionRequest, error)) *MockSessionRequestService_Gets_Call {
	_c.Call.Return(run)
	return _c
}
