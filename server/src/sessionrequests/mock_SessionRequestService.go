...
// BoardCandidateContext provides a mock function with given fields: next
func (_m *MockSessionRequestService) BoardCandidateContext(next http.Handler) http.Handler {
	ret := _m.Called(next)
...
func (_c *MockSessionRequestService_BoardCandidateContext_Call) Return(_a0 http.Handler) *MockSessionRequestService_BoardCandidateContext_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *MockSessionRequestService_BoardCandidateContext_Call) RunAndReturn(run func(http.Handler) http.Handler) *MockSessionRequestService_BoardCandidateContext_Call {
	_c.Call.Return(run)
	return _c
}
...
// OpenSocket provides a mock function with given fields: ctx, w, r
func (_m *MockSessionRequestService) OpenSocket(ctx context.Context, w http.ResponseWriter, r *http.Request) {
	_m.Called(ctx, w, r)
}
...
func (_c *MockSessionRequestService_OpenSocket_Call) RunAndReturn(run func(context.Context, http.ResponseWriter, *http.Request)) *MockSessionRequestService_OpenSocket_Call {
	_c.Run(run)
	return _c
}
