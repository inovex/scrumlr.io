...
func testCloseVotingUpdateRank(t *testing.T) {
	...
	note1, _ := testDb.notesDB.GetNote(fixture.MustRow("Note.votingSortingNote1").(*notes.NoteDB).ID)
	note2, _ := testDb.notesDB.GetNote(fixture.MustRow("Note.votingSortingNote2").(*notes.NoteDB).ID)
	note3, _ := testDb.notesDB.GetNote(fixture.MustRow("Note.votingSortingNote3").(*notes.NoteDB).ID)
	note4, _ := testDb.notesDB.GetNote(fixture.MustRow("Note.votingSortingNote4").(*notes.NoteDB).ID)
	note5, _ := testDb.notesDB.GetNote(fixture.MustRow("Note.votingSortingNote5").(*notes.NoteDB).ID)
	note6, _ := testDb.notesDB.GetNote(fixture.MustRow("Note.votingSortingNote6").(*notes.NoteDB).ID)
