...
func (_mock *MockVotingDatabase) Get(ctx context.Context, board uuid.UUID, id uuid.UUID) (DatabaseVoting, []DatabaseVote, error) {
	...
	var r1 []DatabaseVote
	var r2 error
	if returnFunc, ok := ret.Get(0).(func(context.Context, uuid.UUID, uuid.UUID) (DatabaseVoting, []DatabaseVote, error)); ok {
	...
	if returnFunc, ok := ret.Get(1).(func(context.Context, uuid.UUID, uuid.UUID) []DatabaseVote); ok {
...
func (_c *MockVotingDatabase_Get_Call) RunAndReturn(run func(ctx context.Context, board uuid.UUID, id uuid.UUID) (DatabaseVoting, []DatabaseVote, error)) *MockVotingDatabase_Get_Call {
	_c.Call.Return(run)
	return _c
}

// GetAll provides a mock function for the type MockVotingDatabase
func (_mock *MockVotingDatabase) GetAll(ctx context.Context, board uuid.UUID) ([]DatabaseVoting, []DatabaseVote, error) {
	...
	var r1 []DatabaseVote
	var r2 error
	if returnFunc, ok := ret.Get(0).(func(context.Context, uuid.UUID) ([]DatabaseVoting, []DatabaseVote, error)); ok {
	...
	if returnFunc, ok := ret.Get(1).(func(context.Context, uuid.UUID) []DatabaseVote); ok {
...
func (_c *MockVotingDatabase_GetAll_Call) RunAndReturn(run func(ctx context.Context, board uuid.UUID) ([]DatabaseVoting, []DatabaseVote, error)) *MockVotingDatabase_GetAll_Call {
	_c.Call.Return(run)
	return _c
}
