...
// Close provides a mock function with given fields: ctx, id, board, affectedNotes
func (_m *MockVotingService) Close(ctx context.Context, id uuid.UUID, board uuid.UUID, affectedNotes []Note) (*Voting, error) {
	ret := _m.Called(ctx, id, board, affectedNotes)
	...
	var r0 *Voting
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, uuid.UUID, uuid.UUID, []Note) (*Voting, error)); ok {
		return rf(ctx, id, board, affectedNotes)
	}
	if rf, ok := ret.Get(0).(func(context.Context, uuid.UUID, uuid.UUID, []Note) *Voting); ok {
		r0 = rf(ctx, id, board, affectedNotes)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*Voting)
		}
	...
	if rf, ok := ret.Get(1).(func(context.Context, uuid.UUID, uuid.UUID, []Note) error); ok {
		r1 = rf(ctx, id, board, affectedNotes)
	} else {
		r1 = ret.Error(1)
	}
...
func (_c *MockVotingService_Close_Call) Run(run func(ctx context.Context, id uuid.UUID, board uuid.UUID, affectedNotes []Note)) *MockVotingService_Close_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(uuid.UUID), args[2].(uuid.UUID), args[3].([]Note))
	})
	return _c
}

func (_c *MockVotingService_Close_Call) Return(_a0 *Voting, _a1 error) *MockVotingService_Close_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockVotingService_Close_Call) RunAndReturn(run func(context.Context, uuid.UUID, uuid.UUID, []Note) (*Voting, error)) *MockVotingService_Close_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *MockVotingService) GetVotes(ctx context.Context, board uuid.UUID, f VoteFilter) ([]*Vote, error) {
	...
	var r0 []*Vote
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, uuid.UUID, VoteFilter) ([]*Vote, error)); ok {
		return rf(ctx, board, f)
	}
	if rf, ok := ret.Get(0).(func(context.Context, uuid.UUID, VoteFilter) []*Vote); ok {
		r0 = rf(ctx, board, f)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).([]*Vote)
...
func (_c *MockVotingService_GetVotes_Call) RunAndReturn(run func(context.Context, uuid.UUID, VoteFilter) ([]*Vote, error)) *MockVotingService_GetVotes_Call {
	_c.Call.Return(run)
	return _c
}
