...
func (service *Service) Delete(ctx context.Context, body NoteDeleteRequest, noteID uuid.UUID, deletedVotes []*dto.Vote) error {
  log := logger.FromContext(ctx)
...
func (service *Service) deletedNote(user, board, note uuid.UUID, deletedVotes []*dto.Vote, deleteStack bool) {
