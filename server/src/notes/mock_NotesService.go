...
// Delete provides a mock function with given fields: ctx, user, body
func (_m *MockNotesService) Delete(ctx context.Context, user uuid.UUID, body NoteDeleteRequest) error {
	ret := _m.Called(ctx, user, body)
	...
	var r0 error
	if rf, ok := ret.Get(0).(func(context.Context, uuid.UUID, NoteDeleteRequest) error); ok {
		r0 = rf(ctx, user, body)
	} else {
		r0 = ret.Error(0)
	}
...
func (_c *MockNotesService_Delete_Call) Run(run func(ctx context.Context, user uuid.UUID, body NoteDeleteRequest)) *MockNotesService_Delete_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(uuid.UUID), args[2].(NoteDeleteRequest))
	})
	return _c
}
...
func (_c *MockNotesService_Delete_Call) RunAndReturn(run func(context.Context, uuid.UUID, NoteDeleteRequest) error) *MockNotesService_Delete_Call {
	_c.Call.Return(run)
	return _c
}
...
// Update provides a mock function with given fields: ctx, user, body
func (_m *MockNotesService) Update(ctx context.Context, user uuid.UUID, body NoteUpdateRequest) (*Note, error) {
	ret := _m.Called(ctx, user, body)
	...
	var r0 *Note
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, uuid.UUID, NoteUpdateRequest) (*Note, error)); ok {
		return rf(ctx, user, body)
	}
	if rf, ok := ret.Get(0).(func(context.Context, uuid.UUID, NoteUpdateRequest) *Note); ok {
		r0 = rf(ctx, user, body)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*Note)
	...
	if rf, ok := ret.Get(1).(func(context.Context, uuid.UUID, NoteUpdateRequest) error); ok {
		r1 = rf(ctx, user, body)
	} else {
		r1 = ret.Error(1)
	}
...
func (_c *MockNotesService_Update_Call) Run(run func(ctx context.Context, user uuid.UUID, body NoteUpdateRequest)) *MockNotesService_Update_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(uuid.UUID), args[2].(NoteUpdateRequest))
	})
	return _c
}
...
func (_c *MockNotesService_Update_Call) RunAndReturn(run func(context.Context, uuid.UUID, NoteUpdateRequest) (*Note, error)) *MockNotesService_Update_Call {
	_c.Call.Return(run)
	return _c
}
