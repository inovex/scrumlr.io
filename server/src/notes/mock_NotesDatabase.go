...
func (_m *MockNotesDatabase) CreateNote(insert NoteInsert) (NoteDB, error) {
	...
	var r0 NoteDB
	var r1 error
	if rf, ok := ret.Get(0).(func(NoteInsert) (NoteDB, error)); ok {
		return rf(insert)
	}
	if rf, ok := ret.Get(0).(func(NoteInsert) NoteDB); ok {
		r0 = rf(insert)
	} else {
		r0 = ret.Get(0).(NoteDB)
	}

	if rf, ok := ret.Get(1).(func(NoteInsert) error); ok {
		r1 = rf(insert)
	} else {
		r1 = ret.Error(1)
	}
...
func (_c *MockNotesDatabase_CreateNote_Call) Run(run func(insert NoteInsert)) *MockNotesDatabase_CreateNote_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(NoteInsert))
	})
	return _c
}
...
func (_c *MockNotesDatabase_CreateNote_Call) RunAndReturn(run func(NoteInsert) (NoteDB, error)) *MockNotesDatabase_CreateNote_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *MockNotesDatabase) ImportNote(insert NoteImport) (NoteDB, error) {
	ret := _m.Called(insert)
	...
	var r0 NoteDB
	var r1 error
	if rf, ok := ret.Get(0).(func(NoteImport) (NoteDB, error)); ok {
		return rf(insert)
	}
	if rf, ok := ret.Get(0).(func(NoteImport) NoteDB); ok {
		r0 = rf(insert)
	} else {
		r0 = ret.Get(0).(NoteDB)
	}

	if rf, ok := ret.Get(1).(func(NoteImport) error); ok {
		r1 = rf(insert)
	} else {
		r1 = ret.Error(1)
	}
...
func (_c *MockNotesDatabase_ImportNote_Call) Run(run func(insert NoteImport)) *MockNotesDatabase_ImportNote_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(NoteImport))
	})
	return _c
}
...
func (_c *MockNotesDatabase_ImportNote_Call) RunAndReturn(run func(NoteImport) (NoteDB, error)) *MockNotesDatabase_ImportNote_Call {
	_c.Call.Return(run)
	return _c
}

// UpdateNote provides a mock function with given fields: caller, update
func (_m *MockNotesDatabase) UpdateNote(caller uuid.UUID, update NoteUpdate) (NoteDB, error) {
	...
	var r0 NoteDB
	var r1 error
	if rf, ok := ret.Get(0).(func(uuid.UUID, NoteUpdate) (NoteDB, error)); ok {
		return rf(caller, update)
	}
	if rf, ok := ret.Get(0).(func(uuid.UUID, NoteUpdate) NoteDB); ok {
		r0 = rf(caller, update)
	} else {
		r0 = ret.Get(0).(NoteDB)
	}

	if rf, ok := ret.Get(1).(func(uuid.UUID, NoteUpdate) error); ok {
		r1 = rf(caller, update)
	} else {
		r1 = ret.Error(1)
	}
...
func (_c *MockNotesDatabase_UpdateNote_Call) Run(run func(caller uuid.UUID, update NoteUpdate)) *MockNotesDatabase_UpdateNote_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(uuid.UUID), args[1].(NoteUpdate))
	})
	return _c
}
...
func (_c *MockNotesDatabase_UpdateNote_Call) RunAndReturn(run func(uuid.UUID, NoteUpdate) (NoteDB, error)) *MockNotesDatabase_UpdateNote_Call {
	_c.Call.Return(run)
	return _c
}
