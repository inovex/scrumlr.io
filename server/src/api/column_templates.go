...
func (s *Server) createColumnTemplate(w http.ResponseWriter, r *http.Request) {
	ctx, span := tracer.Start(r.Context(), "columntemplate-api-create")
	defer span.End()
...
func (s *Server) getColumnTemplate(w http.ResponseWriter, r *http.Request) {
	ctx, span := tracer.Start(r.Context(), "columntemplate-api-get")
	defer span.End()
	log := logger.FromContext(ctx)
...
func (s *Server) getColumnTemplates(w http.ResponseWriter, r *http.Request) {
	ctx, span := tracer.Start(r.Context(), "columntemplate-api-get-all")
	defer span.End()
	log := logger.FromContext(ctx)
...
func (s *Server) updateColumnTemplate(w http.ResponseWriter, r *http.Request) {
	ctx, span := tracer.Start(r.Context(), "columntemplate-api-update")
	defer span.End()
	log := logger.FromContext(ctx)
...
func (s *Server) deleteColumnTemplate(w http.ResponseWriter, r *http.Request) {
	...
	if err := s.columntemplates.Delete(ctx, boardTemplateId, columnTemplateId, user); err != nil {
