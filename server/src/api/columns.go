...
func (s *Server) createColumn(w http.ResponseWriter, r *http.Request) {
	ctx, span := tracer.Start(r.Context(), "column-api-create")
	defer span.End()
...
func (s *Server) deleteColumn(w http.ResponseWriter, r *http.Request) {
	ctx, span := tracer.Start(r.Context(), "column-api-delete")
	defer span.End()
	log := logger.FromContext(ctx)
...
func (s *Server) updateColumn(w http.ResponseWriter, r *http.Request) {
	ctx, span := tracer.Start(r.Context(), "column-api-update")
	defer span.End()
	log := logger.FromContext(ctx)
...
func (s *Server) getColumn(w http.ResponseWriter, r *http.Request) {
	ctx, span := tracer.Start(r.Context(), "column-api-get")
	defer span.End()
	log := logger.FromContext(ctx)
...
func (s *Server) getColumns(w http.ResponseWriter, r *http.Request) {
	ctx, span := tracer.Start(r.Context(), "column-api-get-all")
	defer span.End()
	log := logger.FromContext(ctx)
