...
func (s *Server) createNote(w http.ResponseWriter, r *http.Request) {
	ctx, span := tracer.Start(r.Context(), "notes-api-create")
	defer span.End()
...
func (s *Server) getNote(w http.ResponseWriter, r *http.Request) {
	ctx, span := tracer.Start(r.Context(), "notes-api-get")
	defer span.End()
	log := logger.FromContext(ctx)
...
func (s *Server) getNotes(w http.ResponseWriter, r *http.Request) {
	ctx, span := tracer.Start(r.Context(), "notes-api-get-all")
	defer span.End()
	log := logger.FromContext(ctx)
...
func (s *Server) updateNote(w http.ResponseWriter, r *http.Request) {
	ctx, span := tracer.Start(r.Context(), "notes-api-update")
	defer span.End()
	log := logger.FromContext(ctx)
	...
	body.ID = noteID
	body.Board = boardID
	note, err := s.notes.Update(ctx, body)
	if err != nil {
...
func (s *Server) deleteNote(w http.ResponseWriter, r *http.Request) {
	...
	if err := s.notes.Delete(ctx, body, note); err != nil {
