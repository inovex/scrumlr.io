...
func (s *Server) createBoardTemplate(w http.ResponseWriter, r *http.Request) {
	ctx, span := tracer.Start(r.Context(), "boardtemplate-api-create")
	defer span.End()
...
func (s *Server) getBoardTemplate(w http.ResponseWriter, r *http.Request) {
	ctx, span := tracer.Start(r.Context(), "boardtemplate-api-get")
	defer span.End()
	log := logger.FromContext(ctx)
...
func (s *Server) getBoardTemplates(w http.ResponseWriter, r *http.Request) {
	ctx, span := tracer.Start(r.Context(), "boardtemplate-api-get-all")
	defer span.End()
	log := logger.FromContext(ctx)
...
func (s *Server) updateBoardTemplate(w http.ResponseWriter, r *http.Request) {
	ctx, span := tracer.Start(r.Context(), "boardtemplate-api-update")
	defer span.End()
	log := logger.FromContext(ctx)
...
func (s *Server) deleteBoardTemplate(w http.ResponseWriter, r *http.Request) {
	ctx, span := tracer.Start(r.Context(), "boardtemplate-api-delete")
	defer span.End()
	log := logger.FromContext(ctx)
