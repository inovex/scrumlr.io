...
func (s *Server) createBoard(w http.ResponseWriter, r *http.Request) {
	ctx, span := tracer.Start(r.Context(), "board-api-create")
	defer span.End()
...
func (s *Server) deleteBoard(w http.ResponseWriter, r *http.Request) {
	ctx, span := tracer.Start(r.Context(), "board-api-delete")
	defer span.End()
	log := logger.FromContext(ctx)
...
func (s *Server) getBoards(w http.ResponseWriter, r *http.Request) {
	ctx, span := tracer.Start(r.Context(), "board-api-get-all")
	defer span.End()
	log := logger.FromContext(ctx)
...
func (s *Server) getBoard(w http.ResponseWriter, r *http.Request) {
	ctx, span := tracer.Start(r.Context(), "board-api-get")
	defer span.End()
	log := logger.FromContext(ctx)
...
func (s *Server) joinBoard(w http.ResponseWriter, r *http.Request) {
	ctx, span := tracer.Start(r.Context(), "board-api-join")
	defer span.End()
	log := logger.FromContext(ctx)
...
func (s *Server) setTimer(w http.ResponseWriter, r *http.Request) {
	ctx, span := tracer.Start(r.Context(), "board-api-set-timer")
	defer span.End()
	log := logger.FromContext(ctx)
...
func (s *Server) deleteTimer(w http.ResponseWriter, r *http.Request) {
	ctx, span := tracer.Start(r.Context(), "board-api-delete-timer")
	defer span.End()
	log := logger.FromContext(ctx)
...
func (s *Server) incrementTimer(w http.ResponseWriter, r *http.Request) {
	ctx, span := tracer.Start(r.Context(), "board-api-increment-timer")
	defer span.End()
	log := logger.FromContext(ctx)
...
func (s *Server) exportBoard(w http.ResponseWriter, r *http.Request) {
	ctx, span := tracer.Start(r.Context(), "board-api-export")
	defer span.End()
	log := logger.FromContext(ctx)
