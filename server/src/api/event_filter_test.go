...
func testRaiseHandShouldBeUpdatedAfterParticipantUpdated(t *testing.T) {
  ...
  updateEvent := &realtime.BoardEvent{
    ...
    Data: sessions.BoardSession{
      RaisedHand: true,
      ID:         originalParticipantSession.ID,
      Role:       common.ParticipantRole,
    },
  }
...
func testIsModModerator(t *testing.T) {
  isMod := sessions.CheckSessionRole(moderatorBoardSession.ID, boardSessions, []common.SessionRole{common.ModeratorRole, common.OwnerRole})
...
func testIsOwnerModerator(t *testing.T) {
  isMod := sessions.CheckSessionRole(ownerBoardSession.ID, boardSessions, []common.SessionRole{common.ModeratorRole, common.OwnerRole})
...
func testIsParticipantModerator(t *testing.T) {
  isMod := sessions.CheckSessionRole(participantBoardSession.ID, boardSessions, []common.SessionRole{common.ModeratorRole, common.OwnerRole})
...
func testColumnFilterAsParticipant(t *testing.T) {
  ...
  returnedColumnEvent := boardSub.eventFilter(columnEvent, participantBoardSession.ID)
...
func testColumnFilterAsOwner(t *testing.T) {
  ...
  returnedColumnEvent := boardSub.eventFilter(columnEvent, ownerBoardSession.ID)
...
func testColumnFilterAsModerator(t *testing.T) {
  ...
  returnedColumnEvent := boardSub.eventFilter(columnEvent, moderatorBoardSession.ID)
...
func testNoteFilterAsParticipant(t *testing.T) {
  ...
  returnedNoteEvent := boardSub.eventFilter(noteEvent, participantBoardSession.ID)
...
func testNoteFilterAsOwner(t *testing.T) {
  ...
  returnedNoteEvent := boardSub.eventFilter(noteEvent, ownerBoardSession.ID)
...
func testNoteFilterAsModerator(t *testing.T) {
  ...
  returnedNoteEvent := boardSub.eventFilter(noteEvent, moderatorBoardSession.ID)
...
func testFilterVotingUpdatedAsOwner(t *testing.T) {
  ...
  returnedVoteEvent := boardSub.eventFilter(votingEvent, ownerBoardSession.ID)
...
func testFilterVotingUpdatedAsModerator(t *testing.T) {
  ...
  returnedVoteEvent := boardSub.eventFilter(votingEvent, moderatorBoardSession.ID)
...
func testFilterVotingUpdatedAsParticipant(t *testing.T) {
  ...
  returnedVoteEvent := boardSub.eventFilter(votingEvent, participantBoardSession.ID)
...
func testInitFilterAsOwner(t *testing.T) {
  ...
  returnedInitEvent := eventInitFilter(initEvent, ownerBoardSession.ID)
...
func testInitFilterAsModerator(t *testing.T) {
  expectedInitEvent := initEvent
  returnedInitEvent := eventInitFilter(initEvent, moderatorBoardSession.ID)
...
func testInitFilterAsParticipant(t *testing.T) {
  ...
  returnedInitEvent := eventInitFilter(initEvent, participantBoardSession.ID)
