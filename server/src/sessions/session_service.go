...
func (service *BoardSessionService) Update(ctx context.Context, body BoardSessionUpdateRequest) (*BoardSession, error) {
	...
	if sessionOfCaller.Role == SessionRoleParticipant && body.User != body.Caller {
	...
	if body.Role != nil {
		if sessionOfCaller.Role == SessionRoleParticipant && *body.Role != SessionRoleParticipant {
			return nil, common.ForbiddenError(errors.New("cannot promote role"))
		} else if sessionOfUserToModify.Role == SessionRoleOwner && *body.Role != SessionRoleOwner {
...
func (service *BoardSessionService) List(_ context.Context, boardID uuid.UUID, filter BoardSessionFilter) ([]*BoardSession, error) {
...
func (service *BoardSessionService) SessionExists(_ context.Context, boardID, userID uuid.UUID) (bool, error) {
...
func (service *BoardSessionService) ParticipantBanned(_ context.Context, boardID, userID uuid.UUID) (bool, error) {
