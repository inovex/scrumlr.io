...
// Gets provides a mock function with given fields: board, filter
func (_m *MockSessionDatabase) Gets(board uuid.UUID, filter ...BoardSessionFilter) ([]DatabaseBoardSession, error) {
...
// MockSessionDatabase_Gets_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'Gets'
type MockSessionDatabase_Gets_Call struct {
	*mock.Call
}
...
func (_e *MockSessionDatabase_Expecter) Gets(board interface{}, filter ...interface{}) *MockSessionDatabase_Gets_Call {
	return &MockSessionDatabase_Gets_Call{Call: _e.mock.On("Gets",
		append([]interface{}{board}, filter...)...)}
}

func (_c *MockSessionDatabase_Gets_Call) Run(run func(board uuid.UUID, filter ...BoardSessionFilter)) *MockSessionDatabase_Gets_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *MockSessionDatabase_Gets_Call) Return(_a0 []DatabaseBoardSession, _a1 error) *MockSessionDatabase_Gets_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockSessionDatabase_Gets_Call) RunAndReturn(run func(uuid.UUID, ...BoardSessionFilter) ([]DatabaseBoardSession, error)) *MockSessionDatabase_Gets_Call {
	_c.Call.Return(run)
	return _c
}
