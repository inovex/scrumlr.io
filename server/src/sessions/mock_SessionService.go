...
// List provides a mock function with given fields: ctx, boardID, filter
func (_m *MockSessionService) List(ctx context.Context, boardID uuid.UUID, filter BoardSessionFilter) ([]*BoardSession, error) {
...
func (_e *MockSessionService_Expecter) List(ctx interface{}, boardID interface{}, filter interface{}) *MockSessionService_List_Call {
	return &MockSessionService_List_Call{Call: _e.mock.On("List", ctx, boardID, filter)}
}

func (_c *MockSessionService_List_Call) Run(run func(ctx context.Context, boardID uuid.UUID, filter BoardSessionFilter)) *MockSessionService_List_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *MockSessionService_List_Call) Return(_a0 []*BoardSession, _a1 error) *MockSessionService_List_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockSessionService_List_Call) RunAndReturn(run func(context.Context, uuid.UUID, BoardSessionFilter) ([]*BoardSession, error)) *MockSessionService_List_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *MockSessionService) ParticipantBanned(ctx context.Context, boardID uuid.UUID, userID uuid.UUID) (bool, error) {
	ret := _m.Called(ctx, boardID, userID)
...
// MockSessionService_ParticipantBanned_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'ParticipantBanned'
type MockSessionService_ParticipantBanned_Call struct {
	*mock.Call
}
...
//   - boardID uuid.UUID
//   - userID uuid.UUID
func (_e *MockSessionService_Expecter) ParticipantBanned(ctx interface{}, boardID interface{}, userID interface{}) *MockSessionService_ParticipantBanned_Call {
	return &MockSessionService_ParticipantBanned_Call{Call: _e.mock.On("ParticipantBanned", ctx, boardID, userID)}
}

func (_c *MockSessionService_ParticipantBanned_Call) Run(run func(ctx context.Context, boardID uuid.UUID, userID uuid.UUID)) *MockSessionService_ParticipantBanned_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(uuid.UUID), args[2].(uuid.UUID))
	})
	return _c
...
func (_c *MockSessionService_ParticipantBanned_Call) Return(_a0 bool, _a1 error) *MockSessionService_ParticipantBanned_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockSessionService_ParticipantBanned_Call) RunAndReturn(run func(context.Context, uuid.UUID, uuid.UUID) (bool, error)) *MockSessionService_ParticipantBanned_Call {
	_c.Call.Return(run)
	return _c
}

// SessionExists provides a mock function with given fields: ctx, boardID, userID
func (_m *MockSessionService) SessionExists(ctx context.Context, boardID uuid.UUID, userID uuid.UUID) (bool, error) {
	ret := _m.Called(ctx, boardID, userID)
...
//   - boardID uuid.UUID
//   - userID uuid.UUID
func (_e *MockSessionService_Expecter) SessionExists(ctx interface{}, boardID interface{}, userID interface{}) *MockSessionService_SessionExists_Call {
	return &MockSessionService_SessionExists_Call{Call: _e.mock.On("SessionExists", ctx, boardID, userID)}
}

func (_c *MockSessionService_SessionExists_Call) Run(run func(ctx context.Context, boardID uuid.UUID, userID uuid.UUID)) *MockSessionService_SessionExists_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(uuid.UUID), args[2].(uuid.UUID))
	})
	return _c
...
func (_c *MockSessionService_SessionExists_Call) Return(_a0 bool, _a1 error) *MockSessionService_SessionExists_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockSessionService_SessionExists_Call) RunAndReturn(run func(context.Context, uuid.UUID, uuid.UUID) (bool, error)) *MockSessionService_SessionExists_Call {
	_c.Call.Return(run)
	return _c
}
