...
func (_m *MockSessionService) Create(ctx context.Context, body BoardSessionCreateRequest) (*BoardSession, error) {
	...
	var r0 *BoardSession
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, BoardSessionCreateRequest) (*BoardSession, error)); ok {
		return rf(ctx, body)
	}
	if rf, ok := ret.Get(0).(func(context.Context, BoardSessionCreateRequest) *BoardSession); ok {
		r0 = rf(ctx, body)
	} else {
		if ret.Get(0) != nil {
	...
	if rf, ok := ret.Get(1).(func(context.Context, BoardSessionCreateRequest) error); ok {
		r1 = rf(ctx, body)
	} else {
		r1 = ret.Error(1)
	}
...
func (_c *MockSessionService_Create_Call) Run(run func(ctx context.Context, body BoardSessionCreateRequest)) *MockSessionService_Create_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(BoardSessionCreateRequest))
	})
	return _c
}
...
func (_c *MockSessionService_Create_Call) RunAndReturn(run func(context.Context, BoardSessionCreateRequest) (*BoardSession, error)) *MockSessionService_Create_Call {
	_c.Call.Return(run)
	return _c
}
