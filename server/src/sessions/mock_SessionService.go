...
// UpdateUserBoards provides a mock function for the type MockSessionService
func (_mock *MockSessionService) UpdateUserBoards(ctx context.Context, body BoardSessionUpdateRequest) ([]*BoardSession, error) {
	ret := _mock.Called(ctx, body)
...
func (_c *MockSessionService_UpdateUserBoards_Call) Return(boardSessions []*BoardSession, err error) *MockSessionService_UpdateUserBoards_Call {
	_c.Call.Return(boardSessions, err)
	return _c
}

func (_c *MockSessionService_UpdateUserBoards_Call) RunAndReturn(run func(ctx context.Context, body BoardSessionUpdateRequest) ([]*BoardSession, error)) *MockSessionService_UpdateUserBoards_Call {
	_c.Call.Return(run)
	return _c
}
