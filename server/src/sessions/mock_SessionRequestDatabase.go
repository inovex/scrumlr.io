...
func (_m *MockSessionRequestDatabase) GetBoardSessionRequests(board uuid.UUID, status ...BoardSessionRequestStatus) ([]DatabaseBoardSessionRequest, error) {
	...
	var r0 []DatabaseBoardSessionRequest
	var r1 error
	if rf, ok := ret.Get(0).(func(uuid.UUID, ...BoardSessionRequestStatus) ([]DatabaseBoardSessionRequest, error)); ok {
		return rf(board, status...)
	}
	if rf, ok := ret.Get(0).(func(uuid.UUID, ...BoardSessionRequestStatus) []DatabaseBoardSessionRequest); ok {
		r0 = rf(board, status...)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).([]DatabaseBoardSessionRequest)
	...
	if rf, ok := ret.Get(1).(func(uuid.UUID, ...BoardSessionRequestStatus) error); ok {
		r1 = rf(board, status...)
	} else {
		r1 = ret.Error(1)
	}
...
func (_c *MockSessionRequestDatabase_GetBoardSessionRequests_Call) Run(run func(board uuid.UUID, status ...BoardSessionRequestStatus)) *MockSessionRequestDatabase_GetBoardSessionRequests_Call {
	_c.Call.Run(func(args mock.Arguments) {
		variadicArgs := make([]BoardSessionRequestStatus, len(args)-1)
		for i, a := range args[1:] {
			if a != nil {
				variadicArgs[i] = a.(BoardSessionRequestStatus)
			}
		}
...
func (_c *MockSessionRequestDatabase_GetBoardSessionRequests_Call) RunAndReturn(run func(uuid.UUID, ...BoardSessionRequestStatus) ([]DatabaseBoardSessionRequest, error)) *MockSessionRequestDatabase_GetBoardSessionRequests_Call {
	_c.Call.Return(run)
	return _c
}
