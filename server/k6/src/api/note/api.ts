...
import { CreateNoteRequest, DeleteNoteRequest, UpdateNoteRequest } from "./requests.ts";
...
export class NoteClient extends BaseClient {
  ...
  updateNote(boardId: string, noteId: string, updateReq: UpdateNoteRequest, cookieJar?: http.CookieJar): [Note | null, http.Response] {
