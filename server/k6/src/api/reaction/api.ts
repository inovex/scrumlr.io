...
import { CreateReactionRequest, UpdateReactionRequest } from "./requests.ts";
import { Reaction } from "../../types/reaction.ts";

export class ReactionClient extends BaseClient {
  createReaction(boardId: string, reactReq: CreateReactionRequest, cookieJar?: http.CookieJar): [Reaction | null, http.Response] {
  ...
  updateReaction(boardId: string, reactionId: string, updateReq: UpdateReactionRequest, cookieJar?: http.CookieJar): [Reaction | null, http.Response] {
