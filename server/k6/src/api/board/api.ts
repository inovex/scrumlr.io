...
import { Board, BoardOverview } from "../../types/board.ts"
...
export class BoardClient extends BaseClient {
  ...
  updateBoard(boardId: string, updateReq: UpdateBoardRequest, cookieJar?: http.CookieJar): [Board | null, http.Response] {
