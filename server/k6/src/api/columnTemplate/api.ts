...
import { ColumnTemplateRequest } from "./requests.ts";
import { ColumnTemplate } from "../../types/columnTemplate.ts";

export class ColumnTemplateClient extends BaseClient {
  createColumnTemplate(templateId: string, colReq: ColumnTemplateRequest, cookieJar?: http.CookieJar): [ColumnTemplate | null, http.Response] {
  ...
  getColumnTemplate(templateId: string, columnId: string, cookieJar?: http.CookieJar): [ColumnTemplate | null, http.Response] {
  ...
  updateColumnTemplate(templateId: string, columnId: string, updateReq: ColumnTemplateRequest, cookieJar?: http.CookieJar): [ColumnTemplate | null, http.Response] {
