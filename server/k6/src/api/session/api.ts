...
import { BoardSessionUpdateRequest, BoardSessionsUpdateRequest } from "./requests.ts";
import { Role } from "../../types/roles.ts";
import {BoardSession} from "../../types/session.ts"

export class SessionClient extends BaseClient {
  getParticipants(boardId: string, connected: boolean | null = null, ready: boolean | null = null, raisedHand: boolean | null = null, role: Role | null = null, cookieJar?: http.CookieJar): [BoardSession[] | null, http.Response] {
  ...
  updateParticipants(boardId: string, updateReq: BoardSessionsUpdateRequest, cookieJar?: http.CookieJar): [BoardSession[] | null, http.Response] {
  ...
  updateParticipant(boardId: string, sessionId: string, updateReq: BoardSessionUpdateRequest, cookieJar?: http.CookieJar): [BoardSession | null, http.Response] {
