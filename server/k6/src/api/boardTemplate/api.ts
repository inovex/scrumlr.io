...
import { CreateBoardTemplateRequest, UpdateBoardTemplateRequest } from "./requests.ts";
import { BoardTemplate, BoardTemplateFull } from "../../types/boardTemplate.ts";

export class BoardTemplateClient extends BaseClient {
  createBoardTemplate(templateReq: CreateBoardTemplateRequest, cookieJar?: http.CookieJar): [BoardTemplate | null,  http.Response] {
  ...
  updateBoardTemplate(templateId: string, updateReq: UpdateBoardTemplateRequest, cookieJar?: http.CookieJar): [BoardTemplate | null,  http.Response] {
