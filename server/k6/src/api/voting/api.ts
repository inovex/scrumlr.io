...
import { CreateVotingRequest } from "./requests.ts";
import {Voting} from "../../types/voting.ts"

export class VotingClient extends BaseClient {
  createVoting(boardId: string, votingReq: CreateVotingRequest, cookieJar?: http.CookieJar): [Voting | null, http.Response] {
