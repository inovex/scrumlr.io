...
| `frontend.image.args`                                        | Arguments for the scrumlr backend                                                           | `[]`                                         |
| `frontend.replicaCount`                                      | Set the replica count for the backend                                                       | `1`                                          |
| `frontend.autoscaling.enabled`                               | Enable autoscaling                                                                          | `false`                                      |
| `frontend.autoscaling.minReplicas`                           | Min replicas for autoscaling                                                                | `1`                                          |
...
| `frontend.env`                                               | Additional env entries (e.g. configMapRef/secretRef)                                        | `[]`                                         |
| `frontend.resources`                                         | Set container requests and limits for different resources like CPU or memory                | `{}`                                         |
| `frontend.podSecurityContext.seccompProfile.type`            | Set the seccomp profile type of the pod                                                     | `RuntimeDefault`                             |
| `frontend.containerSecurityContext.allowPrivilegeEscalation` | Set controller container's Security Context allowPrivilegeEscalation                        | `false`                                      |
| `frontend.automountServiceAccountToken`                      | Mount Service Account token in pod                                                          | `false`                                      |
...
| `backend.env`                                               | Additional env entries (e.g. configMapRef/secretRef)                                        | `[]`                                       |
| `backend.resources`                                         | Set container requests and limits for different resources like CPU or memory                | `{}`                                       |
| `backend.podSecurityContext.seccompProfile.type`            | Set the seccomp profile type of the pod                                                     | `RuntimeDefault`                           |
| `backend.containerSecurityContext.allowPrivilegeEscalation` | Set controller container's Security Context allowPrivilegeEscalation                        | `false`                                    |
