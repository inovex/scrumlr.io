...
We welcome contributors who use modern development tools, but we ask that you use AI and LLM-based tools (e.g. GitHub Copilot, ChatGPT, Claude) **responsibly and with full understanding of the code you submit**.

Specifically:

- **Do not submit pull requests that are entirely or largely generated by AI without reviewing and understanding the changes yourself.** Every line of code in your PR should be code you can explain, defend, and stand behind.
- **Do not use automated bots or scripts to open pull requests on your behalf.** PRs must be authored and reviewed by a human contributor.
- **AI-assisted contributions are allowed**, as long as you have thoroughly read, understood, and manually verified the suggested changes before submitting.

The goal of these guidelines is to maintain code quality and ensure that contributors are genuinely engaged with the codebase. Reviewers may ask you to explain specific parts of your contribution — if you are unable to do so, the PR may be closed. **Pull requests submitted by accounts that appear to be automated bots or AI agents (e.g. no profile information, bot-like usernames, no prior human activity) will be closed without review.**
