                ...
                if (boardPublicSettings.admissionControl) {
                    ...
                    if (state.isPendingQueryAdded) {
                        if (isLoaded(pending)) {
                            if (
                                isEmpty(pending) ||
                                pending[currentUserUid] === null ||
                                pending[currentUserUid].approved === null ||
                                pending[currentUserUid].approved === undefined
                            ) {
                        ...
                        setState({
                            ...
                            databaseQueries: [
                                ...state.databaseQueries,
                                { collection: 'boards', doc: id, subcollections: [{ collection: 'pending', doc: currentUserUid }], storeAs: 'pending' }
                            ]
                        });
                    }
                } else {
