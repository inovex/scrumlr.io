...
export const SearchBar = (props: SearchBarProps) => {
  ...
  return (
    <div className={classNames("search-bar", {"search-bar--disabled": props.disabled, "search-bar--closable": props.closable}, props.className)}>
      ...
      <input className="search-bar__input" type="text" placeholder={t("SearchBar.placeholder")} disabled={props.disabled} tabIndex={0} />
      {props.closable && (
        <div className="search-bar__icon-container search-bar__icon-container--close-icon" role="button" tabIndex={0} onClick={() => props.onClose?.()}>
