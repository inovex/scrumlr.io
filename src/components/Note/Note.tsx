...
import "./Note.scss";
import {NoteSortable} from "components/DragAndDrop/NoteSortable";
...
export const Note = (props: NoteProps) => {
  ...
  return (
    <NoteSortable id={props.noteId} columnId={note?.position.column} className={classNames("note__root", props.colorClassName)} disabled={!(isModerator || allowStacking)}>
