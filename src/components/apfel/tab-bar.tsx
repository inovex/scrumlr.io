...
import {ReactNode, RefAttributes, SetStateAction, createContext, forwardRef, useContext, useMemo, useRef, useState} from "react";
...
export const TabBar: (props: TabBarProperties & RefAttributes<ComponentInternals>) => ReactNode = forwardRef(({value: valueProp, defaultValue, onValueChange, ...props}, ref) => {
...
export const TabBarItem: (props: TabBarItemProperties & RefAttributes<ComponentInternals>) => ReactNode = forwardRef(({value: tabValue, children, icon, ...props}, ref) => {
