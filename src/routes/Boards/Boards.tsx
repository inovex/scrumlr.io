  ...
  const renderExpandedView = () =>
    boardView !== "create" ? (
      <>
        ...
        {/* desktop search  bar */}
        <Input className="boards__search-bar" type="text" clearable searchable placeholder={t("Input.placeholder.search")} input={searchBarInput} setInput={setSearchBarInput} />
