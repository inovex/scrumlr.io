...
const UserConsent: React.FC<UserConsentProps> = () => {
    ...
    const message = (
        <>
            ...
            for application monitoring and error tracking. By clicking &ldquo;{ACCEPT_BUTTON_TEXT}&rdquo; or exiting this banner you accept to the use of these services. You can change your
