...
describe('note actions', () => {
    ...
    describe('created note', () => {
        ...
        test('created action', () => {
            const action = NoteActionFactory.createdNote({ test: true } as any);
            expect(action).toEqual({
    ...
    describe('updated note', () => {
        ...
        test('created action', () => {
            const action = NoteActionFactory.updatedNote({ test: true } as any);
            expect(action).toEqual({
    ...
    describe('initialize notes', () => {
        ...
        test('created action', () => {
            const action = NoteActionFactory.initializeNotes([{ test: true }] as any[]);
            expect(action).toEqual({
