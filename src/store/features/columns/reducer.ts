...
import {createColumnOptimistically, deleteColumnOptimistically, deletedColumn, editColumnOptimistically} from "./actions";
...
export const columnsReducer = createReducer(
  ...
  // TODO initializeBoard type
  // .addMatcher(isAnyOf(initializeBoard, updatedColumns), (_state, action) => action.payload)
);
