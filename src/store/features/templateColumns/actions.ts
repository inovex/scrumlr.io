...
export const editTemplateColumnOptimistically = createAction<{columnId: string; overwrite: Partial<TemplateColumn>}>("templateColumns/editTemplateColumnOptimistically");
export const deleteTemplateColumnOptimistically = createAction<{columnId: string}>("templateColumns/deleteTemplateColumnOptimistically");
