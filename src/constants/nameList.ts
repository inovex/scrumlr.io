export type NameList = Record<string, Array<string>>;

export const ANIMAL_NAMES: NameList = {
  ...
  K: ["Koala", "Kangaroo", "Kiwi"],
  L: ["Leopard", "Lion", "Llama", "Lemur", "Lizard", "Lobster", "Lemming", "Lynx"],
  M: ["Mole", "Monkey", "Moose", "Mouse", "Mule", "Mockingbird"],
  N: ["Nandu", "Nighthawk"],
  O: ["Opossum", "Owl", "Octopus", "Orca", "Ostrich", "Otter", "Orangutan", "Okapi", "Ocelot", "Oyster"],
...
export const MYTHICAL_CREATURES: NameList = {
  A: ["Alien", "Angel"],
  B: ["Bigfoot", "Bogeyman", "Bookworm"],
  C: ["Centaur", "Cerberus", "Chtulhu", "Cyclops"],
  D: ["Demon", "Devil", "Doppelganger", "Dragon", "Dwarf"],
  E: ["Elf", "Erlking"],
  F: ["Fairy"],
  ...
  R: ["Redcap", "Revenant"],
  S: ["Santa", "Sasquatch", "Satan", "Satyr", "Siren", "Sorcerer", "Sorceress", "Sphinx", "Succubus", "Skywalker"],
  T: ["Thunderbird", "Troll"],
  U: ["Undead", "Unicorn"],
  V: ["Vampire"],
  W: ["Warlock", "Werewolf", "Witch", "Witcher", "Wizard", "Wraith"],
  Y: ["Yeti"],
  Z: ["Zombie"],
};

export const ADJECTIVES: NameList = {
  ...
  F: ["Fabulous", "Fake", "Fast", "Fearless", "Focused", "Foolish", "Fresh", "Funky", "Funny", "Furious", "Fearsome"],
  ...
  J: ["Jealous", "Jazzy", "Jurassic", "Jumpy", "Jacobean", "Jowly", "Jarring", "Justified", "Joyful", "Juvenile", "Judgmental", "Jinxed", "Jeering", "Jovial", "Jesting"],
  K: ["Keen", "Kind", "Kissy", "Knowing", "Kinetic", "Knightly"],
